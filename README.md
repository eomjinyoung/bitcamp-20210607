...
- 이론
  ...
  - 리팩토링 수행
    ...
    - 인터페이스 문법의 용도
      - 인터페이스를 정의하는 법
      - 인터페이스를 구현하는 법
    - 인터페이스 문법을 이용하여 핸들러 클래스의 구현을 통일하기
    - 스태틱 변수의 한계점 확인
- 실습
  - 게시글 관리 미니 애플리케이션 만들기: java-project-01
    - src-19: 메뉴 선택 기능을 추가
    - src-20: 리팩토링: 메서드 추출 => 게시글 관리 메뉴 처리 코드를 별도의 메서드를 분리한다.
    - src-21: 리팩토링: 
...
- 실습
  - 게시글 관리 미니 애플리케이션 만들기: java-project-01
    ...
    - src-31: 인스턴스를 만들 때 반드시 값을 설정하도록 강제하기
      - 생성자 문법을 적용한다.
